...
/*
  Implementation of ThreadPool which consists of a threads which run lambdas from ThreadWorker. 
*/
class ThreadPool
{
private:
...
public:
	...
	auto push(F&& f, Args&&... args) -> std::future<decltype(f(args...))>
	{
		...
		auto taskPtr = std::make_shared<std::packaged_task<decltype(f(args...))()>>(tmpFunc);
